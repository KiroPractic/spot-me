...
<div class="landing-container">
				...
				<div class="col-md-4">
					<div class="feature-card">
						...
						<p class="text-muted">
							...
							from SpotMe. Seamlessly integrated with your Spotify data.
						</p>
					</div>
				</div>
			</div>
				...
				<div class="col-md-3">
					<div class="step-card">
						...
						<p class="text-muted">
							...
							history files to SpotMe. You can upload multiple files at once.
						</p>
					</div>
				</div>
				<div class="col-md-3">
	...
	<section class="benefits-section py-5">
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6">
					<h2 class="display-5 fw-bold mb-4">Why Use SpotMe?</h2>
					...
					<div class="benefit-item">
						<div class="d-flex align-items-start">
							...
							<div>
								...
								<p class="text-muted mb-0">
									SpotMe is free to use. No subscriptions, no hidden fees. Just upload your 
			...
			<div class="row">
				<div class="col-12 text-center">
					...
					<p class="lead text-muted mb-4">
						Join SpotMe today and discover insights about your Spotify listening habits
					</p>
